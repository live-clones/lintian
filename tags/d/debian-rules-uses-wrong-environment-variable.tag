...
Explanation: The rules file appears to be reading or modifying a variable not
 ...
 .
 The special variables <code>DEB&lowbar;*FLAGS&lowbar;{SET,APPEND}</code> can be used by
 users who want to re-compile Debian packages with special (or
 non-standard) build flags.
 .
 Please use the <code>DEB&lowbar;*FLAGS&lowbar;MAINT&lowbar;{SET,APPEND}</code> flags instead.
