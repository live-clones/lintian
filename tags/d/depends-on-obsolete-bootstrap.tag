Tag: depends-on-obsolete-bootstrap
Severity: warning
Check: fields/package-relations
Explanation: The package depends on an unmaintained version of bootstrap.
 ...
 the dependency may not be enough. The following links provide some guidelines
 to help developers to migrate:
 .
