Tag: systemd-alternatives
Severity: error
Check: scripts
Explanation: An alternative is being added for a systemd configuration file.
 Alternatives must not be used for systemd configuration files. Instead please
 make use of the native override/drop-in mechanisms. This applies not only to the
