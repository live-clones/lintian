...
qr{microsoft [ ] visual [ ] c[+][+] [ ] generated (?![ ] by [ ] freeze\.py)}msx
    ...
    # not really a license but warn it: autogenerated file
    'source-contains-autogenerated-generic' => {
        keywords => [qw{file generated}],
        sentences => ['generated by'],
        regex =>
qr{file [ ] (?:was|is) [ ] generated [ ] by}msx
    },
    # not really a license but warn it: autogenerated file do not edit by hand
    'source-contains-autogenerated-generic' => {
        keywords => [qw{edit hand}],
        sentences => ['edit by hand'],
        regex =>
qr{(?:do [ ] not|don't) [ ] edit [ ] by [ ] hand}msx
    },
