...
package Lintian::Profile::Authority::DeveloperReference;
...
Lintian::Profile::Authority::DeveloperReference - Lintian interface to manual references
...
Lintian::Profile::Authority::DeveloperReference provides an interface to manual references.
