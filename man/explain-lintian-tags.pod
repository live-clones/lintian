...
explain-lintian-tags - offer more information about Lintian's tags

=head1 SYNOPSIS

B<explain-lintian-tags> B<--tags> I<tag> ...

=head1 DESCRIPTION

The B<explain-lintian-tags> command explains the named tags given on
the command line.
...
Unlike B<lintian>, B<explain-lintian-tags> will I<not> load any code from
...
If not specified, B<explain-lintian-tags> loads the best profile for the
current vendor.
