...
example, "the python binary" (e.g. /usr/bin/python) vs. "the Python
language".  However, the B<--picky> option will unconditionally flag
the use of "python" as bad despite being correct.
